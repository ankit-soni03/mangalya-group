...
//           </h2>
//           <p className="font-poppins font-light text-[14px] md:text-base text-gray-600 leading-relaxed">
...
//             <div className="w-full max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 text-white font-poppins">
//               {/* Left */}
//               <div>
...
//                 </h4>
//                 <ul className="list-disc pl-5 space-y-1 text-sm md:text-base text-gray-200">
//                   <li>NH-24 close by for easy connectivity to Delhi and NCR</li>
//                   <li>Metro station at walking distance</li>
//                   <li>Noida City Centre Metro Station only 10 minutes away</li>
//                   <li>Faridabad–Noida–Ghaziabad (FNG) Expressway</li>
//                   <li>
//                     Shopping complexes, malls & entertainment zones nearby
//                   </li>
//                 </ul>
//               </div>
//             </div>
