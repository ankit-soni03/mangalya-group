      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-10 items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Card 1 */}
            <div className="bg-black text-white p-5 font-poppins text-sm leading-relaxed">
            ...
            {/* Card 2 */}
            <div className="bg-[#0a8a5a] text-white p-5 font-poppins text-sm leading-relaxed">
              <ul className="list-disc pl-4 space-y-2">
            ...
            {/* Card 3 */}
            <div className="bg-white border border-gray-200 p-5 font-poppins text-sm text-gray-600 leading-relaxed">
              <p>
