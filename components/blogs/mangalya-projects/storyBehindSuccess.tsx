      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-14 items-center">
          ...
          <div className="font-poppins text-gray-300">
            ...
            <Link
              href="/contact"
              className="inline-block bg-white text-black px-8 py-3 text-sm font-medium hover:bg-gray-200 transition"
            >
              Enquire Now
            </Link>
          </div>
          ...
          <div className="relative h-[360px] md:h-[420px] overflow-hidden">
            <Image
              src="/blogs/mangalya-projects/img-1.png" // replace with your image
