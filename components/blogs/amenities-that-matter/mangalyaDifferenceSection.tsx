...
//         {/* Timeline Wrapper */}
//         <div className="relative grid grid-cols-1 md:grid-cols-[260px_1fr] gap-10 mb-14">
//           {/* Vertical Line - positioned to align with dots */}
//           <div className="hidden md:block absolute left-[271px] top-0 bottom-0 w-px bg-gray-300" />

//           {/* LEFT TITLES */}
//           <div className="space-y-28 md:space-y-32">
//             <h3 className="text-lg md:text-[30px] font-medium font-poppins text-gray-900">
//               The Mangalya Group <br /> Difference
//             </h3>

//             <h3 className="text-lg md:text-[30px] font-medium font-poppins">
//               Time is precious
//             </h3>
//           </div>
...
//               {/* Dot ON line - adjusted positioning */}
//               <span className="font-poppins font-regular hidden md:block absolute -left-[34px] top-1 w-3 h-3 bg-green-600 rounded-full z-10" />

//               <p className="mb-4">
//                 At Mangalya Group, we believe a home today is more than a place
//                 to live—it's where life unfolds, dreams take shape, and memories
//                 are made. Our homes are thoughtfully designed to deliver modern
//                 amenities without compromising quality, nature, or social
//                 connectivity.
//               </p>

//               <p className="mb-4">
//                 We understand that the ideal home must be both future-ready and
//                 relevant to everyday needs. That's why our projects integrate
//                 smart home technology, wellness-focused spaces, flexible
//                 layouts, and vibrant community living—reflecting how people live
//                 in 2026.
//               </p>
...
//                 dry cleaning services, and managed delivery packages directly on
//                 the premises.
//               </p>
...
//            <p className="font-handwritten text-lg md:text-[45px] leading-relaxed font-medium">
...
//            <Link
//              href="/contact"
//              className="inline-block bg-black font-light text-white px-7 py-3 text-sm hover:bg-gray-800 transition"
//            >
//              Enquire Now
//            </Link>
//          </div>
