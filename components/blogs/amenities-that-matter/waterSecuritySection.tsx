...
//           <div className="max-w-7xl mx-auto px-4 w-full grid grid-cols-1 md:grid-cols-2 gap-6">
...
//                 The Hard Truth: Nothing can be more pinching than waking up to
//                 5 AM buckets to fill. In 2025, that is not acceptable.
//               </p>

//               <ul className="list-disc pl-5 space-y-1 text-sm md:text-base text-gray-200">
//                 <li>Access to Clean Drinking Water is a Right, Not a Privilege</li>
//                 <li>Uniform water pressure impacts from showers to washing machines</li>
...
//               <h2 className="text-white text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight text-left md:text-right">
//                 Water <br /> Security
//               </h2>
//             </div>
