    ...
    <section className="w-full bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-12 md:py-16 lg:py-20">
        ...
        <div className="flex justify-end">
          <div className="flex items-start gap-4 md:gap-5">
            ...
            <div className="text-right -space-y-1 md:-space-y-2">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[60px] font-bold text-black tracking-[0.15em] font-handwritten leading-none">
                ABOUT
              </h2>
              <div className="flex justify-end">
                <span className="text-4xl sm:text-5xl md:text-6xl lg:text-[64px] text-black font-handwritten leading-none italic">
                  us
                </span>
              </div>
            </div>
        ...
        <div className="mb-12 md:mb-14 lg:mb-5">
          <div className="flex flex-col lg:flex-row lg:items-start gap-4 md:gap-6">
            ...
            <div className="flex-1">
              <h1 className="text-3xl sm:text-4xl md:text-[40px] lg:text-[44px] font-quattrocento leading-snug text-gray-900 text-balance">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-5 relative overflow-hidden h-64 sm:h-72 md:h-80 lg:h-96 group">
            <Image
          ...
          {/* Right Image */}
          <div className="lg:col-span-4 relative overflow-hidden h-64 sm:h-72 md:h-80 lg:h-96 group">
            <Image
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-8">
            <p className="text-base sm:text-lg md:text-[18px] lg:text-[19px] leading-relaxed text-gray-900 font-poppins">
            ...
            {/* Show More Button */}
            <button
              className="flex items-center bg-gray-900 rounded-full pl-6 md:pl-7 pr-2 py-2.5 md:py-3 w-fit hover:bg-gray-800 active:scale-95 transition-all duration-300 group"
