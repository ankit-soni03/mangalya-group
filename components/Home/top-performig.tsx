...
//         {/* TOP-PERFORMING */}
//         <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[52px] font-bold text-black tracking-[0.25em] uppercase mb-3 md:mb-4 font-['Quattrocento_Sans']">
//           TOP-PERFORMING
//         </h2>
...
//           <h3 className="text-3xl sm:text-6xl md:text-7xl lg:text-[40px] xl:text-[90px] text-black font-['Carattere'] italic font-normal">
//             Properties
//           </h3>
