...
//     ),
//     title: "Location",
//     content: ["H-97, sec 63, Noida,", "20122"],
//   },
//   {
//     icon: (
//       <svg
...
//     ),
//     title: "Email",
//     content: ["info@mangalayagroup.in"],
...
//     ),
//     title: "Contact",
//     content: ["+91 8273781839", "+91 8273781839"],
//     href: "tel:+918273781839",
//   },
//   {
//     icon: (
//       <svg
...
//       >
//         <path
//           d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 4C14.5 4 16.5 6 16.5 8.5C16.5 11 14.5 13 12 13C9.5 13 7.5 11 7.5 8.5C7.5 6 9.5 4 12 4ZM12 20C9.5 20 7.5 18.5 7.5 16.5V15.5C7.5 14.5 8.5 14 9.5 14H14.5C15.5 14 16.5 14.5 16.5 15.5V16.5C16.5 18.5 14.5 20 12 20Z"
//           fill="currentColor"
//         />
//         <rect
//           x="7"
...
//                 <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gray-900 flex items-center justify-center text-white">
//                   <svg
//                     width="24"
//                     height="24"
//                     viewBox="0 0 24 24"
...
//             <h3 className="text-2xl md:text-3xl font-serif italic text-gray-900 mb-2">
//               Get in Touch
//             </h3>
...
//                   className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all"
//                   required
//                 />
//               </div>
...
//                   rows={4}
//                   className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all resize-none"
//                   required
//                 />
//               </div>
...
//               <button
//                 type="submit"
//                 className="w-full sm:w-auto px-8 py-3 bg-gray-900 text-white font-medium rounded-lg hover:bg-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
//               >
//                 Submit
//               </button>
//             </form>
